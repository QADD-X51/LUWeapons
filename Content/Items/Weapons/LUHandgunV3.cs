...
{
    public class LUHandgunV3 : ModItem
    {
        //public int gunEXP = 0;
        ...
        {
            DisplayName.SetDefault("LU Handgun V3");
            Tooltip.SetDefault("V3 - Imporoved firepower");
        ...
        public override void AddRecipes()
        {
            ...
            recipeCorr.AddIngredient(ItemID.ShadowScale, 1);
            recipeCorr.AddIngredient(ModContent.ItemType<LUHandgunV2>(), 1);
            recipeCorr.Register();

            Recipe recipeCrim = CreateRecipe();
            recipeCrim.AddIngredient(ItemID.TissueSample, 1);
            recipeCrim.AddIngredient(ModContent.ItemType<LUHandgunV2>(), 1);
            recipeCrim.Register();
        }
